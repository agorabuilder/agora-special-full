 ...
 */
  ...
  */
  ...
  /** Set playing mixing file speed.
   *
   * Call this method when you are mixing music file.
   *
   * @param speed paly speed value [50, 200]
   *
   * @return
   * - 0: Success.
   * - < 0: Failure.
  ...
  */
  ...
  /** Get audio track count the music file.
  ...
  /** Set dual-mono output mode of the music file.
    ...
    @param mode dual mono mode \ref agora::media::AUDIO_MIXING_CHANNEL_MODE
